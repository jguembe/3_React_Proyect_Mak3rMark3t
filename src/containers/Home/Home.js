            ...
            footer = (
              <footer className="footer fixed-bottom mt-auto py-3 bg-light">
                <div className="container">
                    ...
                    <Link to="/realizarpedido" className="btn btn-sm btn-primary my-auto">REALIZAR PEDIDO</Link>
                    <button className="btn btn-sm  ml-5 btn-secondary my-auto" onClick={this.props.reiniciar} type="button"> X (eliminar cesta)</button>
                </div>
              </footer>
            )
          }
